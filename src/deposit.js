...
const  depositM = gql `
    mutation deposit($amount: Float! $currencyID: String!){
      deposit(amount: $amount, currencyID: $currencyID)
    }
  `
...
// }
  ...
  const [deposit, { loading, error, data }] = useMutation(depositM, {
    onCompleted: (data) =>{
      if(data !== undefined ){
       console.log(data)
  ...
  async function handleDeposit() {
    ...
    deposit({ variables: {amount: amount, currencyID: "607ad52962ef10416ad795e2"} });
  }
  ...
  return (
    ...
    <Toast onClose={() => setShow(false)} show={show} delay={2300} autohide>
          ...
          <Toast.Body>Deposit Made</Toast.Body>
        </Toast>
 ...
 <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
        ...
        <Button size="sm" onClick={e => handleSubmit(e)}>Deposit</Button>
      </form>
